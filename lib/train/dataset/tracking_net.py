...
def list_sequences(root, set_ids, if_use_test = 'train', test_seq = None):
...
class TrackingNet(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, set_ids=None, data_fraction=None):
        ...
        self.sequence_list = list_sequences(self.root, self.set_ids, if_use_test = self.use_type)

        self.train_len = len(self.sequence_list)
