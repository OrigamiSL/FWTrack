...
"""
Add default config for FWTrack.
"""
cfg = edict()
...
cfg.DATA.TEMPLATE.SIZE = 144
cfg.DATA.TEMPLATE.FACTOR = 2.0
cfg.DATA.TEMPLATE.CENTER_JITTER = 0
cfg.DATA.TEMPLATE.SCALE_JITTER = 0

cfg.DATA.RANDOM_RATE = 0

cfg.DATA.WAVELETS_LEVEL_S = 4
cfg.DATA.WAVELETS_LEVEL_T = 2
cfg.DATA.WAVELETS_LEVEL_HW = 2
cfg.DATA.WAVELETS_ONLY_W3 = True
cfg.DATA.WAVELETS_USE_HW = False
cfg.DATA.WAVELETS_SEARCH_CROP = 256
cfg.DATA.SEARCH_CROP = 512
...
cfg.TEST.UPDATE_INTERVALS.UAV = 25
